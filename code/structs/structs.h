...
/*************************************************************/
/* 6. Data structure to save the state of the Neural Network */
/*************************************************************/

/*
Saves the bias and weights of the Neural Network (No need to store the connections, as they will always stay the same)*/
typedef struct STATE{
    double* biases;   // Array of doubles representing the biases
    double** weights; // Array of pointers to arrays of doubles to show the respective weights of the Neural Network
} STATE;
